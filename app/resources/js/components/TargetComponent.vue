    ...
    <v-row>
      ...
      <v-col cols="auto">
        <v-sheet rounded="lg" class="spacing-playground pa-6" elevation="0">
          ...
          <div>
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="665px" height="459px" viewBox="-0.5 -0.5 665 459" id="master">
            <defs/>
            <g>
          ...
          <ellipse v-bind:class="stateenv2" id="Env2ndroom" cx="46.5" cy="44" rx="22.270000000000003" ry="22.270000000000003" fill="#81d4fa" stroke="none" pointer-events="all"/>
            ...
            <ellipse cx="121.5" cy="157" rx="22.270000000000003" ry="22.270000000000003" fill="#81d4fa" stroke="none" pointer-events="all"/>
              ...
              <path d="M 91.5 271.32 C 103.93 271.32 114 281.39 114 293.82 C 114 306.25 103.93 316.32 91.5 316.32 C 79.07 316.32 69 306.25 69 293.82 C 69 281.39 79.07 271.32 91.5 271.32 Z M 104.63 280.7 L 86.81 289.13 L 78.38 306.95 L 96.19 298.51 L 104.63 280.7 Z M 91.5 291.01 C 93.05 291.01 94.31 292.27 94.31 293.82 C 94.31 295.37 93.05 296.63 91.5 296.63 C 89.95 296.63 88.69 295.37 88.69 293.82 C 88.69 292.27 89.95 291.01 91.5 291.01 Z" fill="#737373" stroke="none" transform="rotate(45,91.5,293.82)" pointer-events="all"/><rect x="36" y="283.82" width="40" height="20" fill="none" stroke="none" pointer-events="all"/><g transform="translate(-0.5 -0.5)"><switch><foreignObject style="overflow: visible; text-align: left;" pointer-events="none" width="100%" height="100%" requiredFeatures="http://www.w3.org/TR/SVG11/feature#Extensibility"><div xmlns="http://www.w3.org/1999/xhtml" style="display: flex; align-items: unsafe center; justify-content: unsafe center; width: 38px; height: 1px; padding-top: 294px; margin-left: 37px;"><div style="box-sizing: border-box; font-size: 0; text-align: center; "><div style="display: inline-block; font-size: 12px; font-family: Helvetica; color: #000000; line-height: 1.2; pointer-events: all; white-space: normal; word-wrap: normal; "><font style="font-size: 16px" color="#4d4d4d">N</font></div></div></div></foreignObject><text x="56" y="297" fill="#000000" font-family="Helvetica" font-size="12px" text-anchor="middle">N</text></switch></g></g><switch><g requiredFeatures="http://www.w3.org/TR/SVG11/feature#Extensibility"/><a transform="translate(0,-5)" xlink:href="https://desk.draw.io/support/solutions/articles/16000042487" target="_blank"><text text-anchor="middle" font-size="10px" x="50%" y="100%">Viewer does not support full SVG 1.1</text></a></switch>
