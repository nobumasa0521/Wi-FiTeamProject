    ...
    <v-row>
      ...
      <v-col cols="auto">
        <v-sheet rounded="lg" class="spacing-playground pa-6" elevation="0">
          ...
          <div>
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="665px" height="375px" viewBox="-0.5 -0.5 665 375" id="master">
            <defs/>
            <g>
          ...
          <ellipse v-bind:class="stateenv2" id="Env2ndroom" cx="46.5" cy="44" rx="22.270000000000003" ry="22.270000000000003" fill="#81d4fa" stroke="none" pointer-events="all"/>
            ...
            <ellipse cx="121.5" cy="157" rx="22.270000000000003" ry="22.270000000000003" fill="#81d4fa" stroke="none" pointer-events="all"/>
              ...
              <path d="M 87 280.82 C 94.18 280.82 100 286.64 100 293.82 C 100 301 94.18 306.82 87 306.82 C 79.82 306.82 74 301 74 293.82 C 74 286.64 79.82 280.82 87 280.82 Z M 94.58 286.24 L 84.29 291.11 L 79.42 301.4 L 89.71 296.53 L 94.58 286.24 Z M 87 292.2 C 87.9 292.2 88.63 292.92 88.63 293.82 C 88.63 294.72 87.9 295.45 87 295.45 C 86.1 295.45 85.38 294.72 85.38 293.82 C 85.38 292.92 86.1 292.2 87 292.2 Z" fill="#737373" stroke="none" transform="rotate(45,87,293.82)" pointer-events="all"/><rect x="36" y="283.82" width="40" height="20" fill="none" stroke="none" pointer-events="all"/><g transform="translate(-0.5 -0.5)"><switch><foreignObject style="overflow: visible; text-align: left;" pointer-events="none" width="100%" height="100%" requiredFeatures="http://www.w3.org/TR/SVG11/feature#Extensibility"><div xmlns="http://www.w3.org/1999/xhtml" style="display: flex; align-items: unsafe center; justify-content: unsafe center; width: 38px; height: 1px; padding-top: 294px; margin-left: 37px;"><div style="box-sizing: border-box; font-size: 0; text-align: center; "><div style="display: inline-block; font-size: 12px; font-family: Helvetica; color: #000000; line-height: 1.2; pointer-events: all; white-space: normal; word-wrap: normal; "><font style="font-size: 16px" color="#4d4d4d">N</font></div></div></div></foreignObject><text x="56" y="297" fill="#000000" font-family="Helvetica" font-size="12px" text-anchor="middle">N</text></switch></g><switch><g requiredFeatures="http://www.w3.org/TR/SVG11/feature#Extensibility"/><a transform="translate(0,-5)" xlink:href="https://desk.draw.io/support/solutions/articles/16000042487" target="_blank"><text text-anchor="middle" font-size="10px" x="50%" y="100%">Viewer does not support full SVG 1.1</text></a></switch>
